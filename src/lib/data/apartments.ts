...
export const propertyConfigurations: Record<string, PropertyData> = {
  "j7-emporium": {
    ...
    backgroundImage: "J7 Emp/Cam_04 final night light.webp",
    projectDetails: {
      stories: 30,
      totalArea: "46 kanal",
      developer: "J7 Group",
    ...
    floorPlans: {
      Studio: {
        ...
        specialFeatures: [
          "Margalla View (5% extra)",
          "Corner Units (10% extra)",
          "Building facing & Sun facing options",
        ],
      },
      "1 Bedroom": {
        id: "1bed",
      ...
      "3 Bedroom": {
        ...
        specialFeatures: [
          "3-bedroom duplex options available",
  ...
  radisson: {
    ...
    availableUnits: ["Hotel Suites", "Hotel Residences", "Commercial Shops"],
    floors: [
      {
        id: "commercial",
        name: "Commercial Shops",
  ...
  "j7-icon": {
    ...
    location: "Mumtaz City, Srinagar Highway, Islamabad, Pakistan",
    backgroundImage: "J7 Icon/icon3.webp",
    projectDetails: {
      stories: 14,
      totalArea: "Not specified",
  ...
  rotana: {
    ...
    backgroundImage: "Rotana/rotana2.webp",
    projectDetails: {
      stories: 26,
      totalArea: "Not specified",
